...
The iii project as a whole is a multi-licensed open source project. Each
component has its own license, as described below and in the LICENSE file
...
You may use, copy, distribute, and prepare derivative works of the engine,
subject to the limitation that you may not provide it to third parties as a
