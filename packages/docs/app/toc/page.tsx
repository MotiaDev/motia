      ...
      <div className="relative mx-auto w-full max-w-[1200px] pt-[160px] pb-[200px] max-md:px-[16px]">
        <div className="mx-auto w-[660px] max-w-full">
          ...
          <p className="text-center text-[20px] text-white/80 leading-[140%] font-sans mt-[24px]">
            These terms govern your use of <span className={gradientText}>Motia</span> and related services. By using
            Motia, you agree to these terms.
          </p>
        </div>
        ...
        <div className="mx-auto flex w-full max-w-[760px] flex-col gap-[40px]">
          <section className={normalText}>
            ...
            <p>
              By accessing or using Motia, you agree to be bound by these Terms and Conditions. If you disagree with any
              part of these terms, <span className={gradientText}>please contact us.</span>
            </p>
          </section>
          ...
          <section className={normalText}>
            ...
            <p>
              Motia is a <span className={gradientText}>production-grade backend runtime</span> that unifies APIs, 
              background jobs, queues, durable workflows, and AI agents into a single system with built-in state 
              management and observability. The service includes developer tools, cloud infrastructure, and related documentation.
            </p>
          </section>
          ...
          <section className={normalText}>
            ...
            <p>
              ...
              <span className={gradientText}>accurate, complete, and current</span> at all times. You are responsible
          ...
          <section className={normalText}>
            ...
            <p>You may use Motia for lawful purposes only. You agree not to use the service:</p>
          ...
          >
            ...
            <div className="relative flex flex-col gap-[20px]">
              ...
              <p>
                ...
                property of <span className={gradientText}>Motia and its licensors</span>. The Service is protected by
                copyright, trademark, and other laws.
              </p>

              <p>
                <span className={gradientTextBlue}>Your License:</span> Subject to these Terms, we grant you a limited,
                non-exclusive, non-transferable license to use Motia for your development projects.
              </p>
            </div>
          </section>
          ...
          <section className={normalText}>
            ...
            <p>
              ...
              <span className={gradientText}>We collect only the data necessary</span> to provide and improve our
              services.
            </p>
          </section>
          ...
          <section className={normalText}>
            ...
            <p>
              We strive to keep Motia available, but we cannot guarantee uninterrupted access.{' '}
              <span className={gradientTextBlue}>We may modify, suspend, or discontinue</span> any part of the service
          ...
          <section className={normalText}>
            ...
            <p>
              In no event shall Motia, nor its directors, employees, partners, agents, suppliers, or affiliates, be
          ...
          <section className={normalText}>
            ...
            <p>
              ...
              <span className={gradientText}>including but not limited to a breach</span> of the Terms.
            </p>
          </section>
          ...
          <section className={normalText}>
            ...
            <p>
              ...
              <span className={gradientTextBlue}>Our failure to enforce any right or provision</span> of these Terms
          ...
          <section className={`${normalText} mt-[-10px]`}>
            <p>
              These terms help us create a safe, productive environment for all developers using Motia. We&apos;re
              committed to <span className={gradientText}>building tools that empower</span> software engineering teams
              while respecting your rights and privacy.
            </p>
            <p className="mt-[20px]">
              Questions about these terms? Contact at <span className={gradientTextBlue}>mike@motia.dev</span>
            </p>
            <p className="mt-[16px] text-[16px] text-white/40">Last updated: July 2025</p>
          </section>
        </div>
      </div>
