...
const SuccessContent: React.FC = () => (
  <>
    ...
    <div className="relative flex w-full items-center justify-center pt-[35px] pb-[60px]">
      ...
      <Image style={tickShadowStyle} className="relative z-[1]" width={150} src={successModalTick} alt="Success!" />
      <Image src={particles} alt="Particles in background" width={54} className="rotate-180" />
    </div>
    <DialogTitle className="text-center text-[24px] font-medium text-white/90">Thanks for registering!</DialogTitle>
