...
## Step 4: AI Agent Streaming (TypeScript Only)
...
<Callout type="info">
**TypeScript Implementation Only:** Streaming AI enrichment is currently implemented in TypeScript only. The pattern shown here can be applied to Python and JavaScript implementations.

View on GitHub:
- [TypeScript (with streaming)](https://github.com/MotiaDev/build-your-first-app/blob/main/steps/typescript/ai-profile-enrichment.step.ts)
</Callout>
