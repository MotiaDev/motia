...
<Callout type="info">
View on GitHub:
- [TypeScript](https://github.com/MotiaDev/build-your-first-app/blob/workflow-orchestration/src/typescript/pet-lifecycle-orchestrator.step.ts)
- [Python](https://github.com/MotiaDev/build-your-first-app/blob/workflow-orchestration/src/python/pet_lifecycle_orchestrator_step.py)
- [JavaScript](https://github.com/MotiaDev/build-your-first-app/blob/workflow-orchestration/src/javascript/pet-lifecycle-orchestrator.step.js)
</Callout>
...
<Tabs items={['TypeScript', 'Python', 'JavaScript']}>
  <Tab value="TypeScript">
    ...
    async function processAutomaticProgression(petId: string, currentStatus: Pet["status"], enqueue: any, logger: any) {
  ...
  <Tab value="JavaScript">
    ...
    async function processAutomaticProgression(petId, currentStatus, enqueue, logger) {
      // Define automatic progressions
...
- `enqueues: []` - The orchestrator doesn't declare enqueues because it only manages state internally
- JavaScript/Python enqueue messages for workflow tracking (optional pattern)
