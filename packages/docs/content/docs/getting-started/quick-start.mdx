...
<Callout type="info">
**Step Directory:** By default, Motia looks for steps in the `steps/` directory. You can customize this to use any directory structure - see [Project Structure](/docs/project-structure#configuring-step-directories) for details.
</Callout>
