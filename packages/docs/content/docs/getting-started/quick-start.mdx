...
2.  **Click the `Tutorial`** button on the top right of the workbnech.
...
- Build your first application from scratch, follow our **[Build Your First Motia App](/docs/getting-started/build-your-first-app)** guide.
