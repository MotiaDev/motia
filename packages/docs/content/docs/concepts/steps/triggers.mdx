...
**`ctx`** is the same [context object](##context--available-in-all-handlers) all Steps get: `logger`, `emit`, `state`, `streams`, `traceId`.
...
<Cards>
  <Card href="/docs/concepts/steps/steps" title="📝 Defining Steps">
