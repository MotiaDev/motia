...
| `starter-multilang` | Starter (Multi-language) | Polyglot project with TypeScript API and Python event processing |
...
Create a multi-language TypeScript + Python project:
```bash
