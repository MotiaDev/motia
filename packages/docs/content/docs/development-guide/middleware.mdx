...
<Cards>
  <Card href="/docs/concepts/steps/triggers" title="API Triggers">
    Learn more about API Steps
  </Card>
  
  <Card href="/docs/development-guide/observability" title="Observability">
    Monitor and debug your middleware
  </Card>
</Cards>
