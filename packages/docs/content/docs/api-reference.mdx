...
- `-t, --template <name>` - Template to use. Available options:
  - `starter-typescript` - Minimal TypeScript project with basic examples
  - `starter-javascript` - Minimal JavaScript project with basic examples
  - `starter-python` - Minimal Python project with basic examples
  - `motia-tutorial-typescript` - Interactive tutorial project in TypeScript
  - `motia-tutorial-python` - Interactive tutorial project in Python
