...
<div className="my-8">![Trello Automation](https://github.com/MotiaDev/motia-examples/blob/main/examples/trello-flow/docs/images/trello-manager.png?raw=true)</div>
...
<div className="my-8">![Flow: Trello Automation Steps](https://github.com/MotiaDev/motia-examples/blob/main/examples/trello-flow/docs/images/trello-manager.png?raw=true)</div>
