...
<Tabs items={['finance-data', 'openai-analysis', 'query-api', 'response-coordinator', 'result-api', 'save-result', 'web-search']}>
  <CodeFetcher path="examples/finance-agent/src" tab="finance-data" value="finance-data" />
  <CodeFetcher path="examples/finance-agent/src" tab="openai-analysis" value="openai-analysis" />
  <CodeFetcher path="examples/finance-agent/src" tab="query-api" value="query-api" />
  <CodeFetcher path="examples/finance-agent/src" tab="response-coordinator" value="response-coordinator" />
  <CodeFetcher path="examples/finance-agent/src" tab="result-api" value="result-api" />
  <CodeFetcher path="examples/finance-agent/src" tab="save-result" value="save-result" />
  <CodeFetcher path="examples/finance-agent/src" tab="web-search" value="web-search" />
</Tabs>
