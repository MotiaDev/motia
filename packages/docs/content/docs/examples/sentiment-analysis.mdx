...
<div className="my-8">![motia workbench for sentiment analysis](https://github.com/MotiaDev/motia-examples/blob/main/examples/sentimental-analysis/docs/images/sentimental-analyzer-workbench.gif?raw=true)</div>
