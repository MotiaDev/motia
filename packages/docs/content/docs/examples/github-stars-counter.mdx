...
<div className="my-8">![GitHub Stars Counter Demo](https://github.com/MotiaDev/github-stars-counter/blob/main/public/motia-star.gif?raw=true)</div>

**Try it yourself:**
- [View Source Code](https://github.com/MotiaDev/motia-examples/tree/main/examples/github-stars-counter)
