...
pytestmark = pytest.mark.skip(reason="kv_server module is not configured in the test engine")
...
async def test_delete_value(iii_client: III):
    ...
    before_delete = iii_client.trigger({
        "function_id": "kv_server::get",
        "payload": {"index": "test_index", "key": test_key},
    })
    ...
    after_delete = iii_client.trigger({
        "function_id": "kv_server::get",
        "payload": {"index": "test_index", "key": test_key},
    })
