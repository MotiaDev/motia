...
class State:
    ...
    async def get(self, scope: str, key: str) -> Any | None:
        return await self._iii._async_trigger({"function_id": "state::get", "payload": {"scope": scope, "key": key}})

    async def set(self, scope: str, key: str, value: Any) -> Any:
        return await self._iii._async_trigger(
    ...
    async def get_group(self, scope: str) -> list[Any]:
        return await self._iii._async_trigger({"function_id": "state::list", "payload": {"scope": scope}})
