...
declare module 'motia' {
  ...
  type Handlers = {
    'Test State With Python': EventHandler<unknown, { topic: 'check-state-change'; data: never }>
    ...
    'SetStateChange': EventHandler<{ message: string }, { topic: 'check-state-change'; data: never }>
