...
export const LicenseModal: React.FC<LicenseModalProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-iii-black/90 backdrop-blur-md p-4 animate-fade-in" onClick={onClose}>
      <div className="w-full max-w-lg bg-iii-dark border border-iii-accent/30 shadow-2xl relative overflow-hidden" onClick={e => e.stopPropagation()}>
        <div className="bg-iii-accent/10 px-6 py-4 border-b border-iii-accent/20 flex items-center justify-between">
          <div className="flex items-center gap-3 text-iii-accent">
            ...
            <h2 className="font-mono font-bold tracking-wider">PROTOCOL SPECIFICATION</h2>
          </div>
        ...
        <div className="p-8 space-y-6 relative">
          <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none select-none overflow-hidden">
            <span className="text-[120px] font-black text-red-500 -rotate-12 whitespace-nowrap">NO LICENSE</span>
          </div>
          ...
          <div className="space-y-4 font-mono text-sm leading-relaxed text-iii-light/80">
            ...
            <p>
              This specification explicitly grants <span className="text-white font-bold bg-red-500/20 px-1 rounded-sm">NO PATENT RIGHTS</span>. 
              Reading it describes the invention, but gives absolutely no legal permission to implement the backend logic that executes it.
            </p>

            <div className="border-l-2 border-iii-medium pl-4 py-1 my-4">
              <h3 className="text-white font-bold mb-1">The "Look but Don't Touch" Shield</h3>
              <p className="text-xs text-iii-medium">
                Prevents competitors from claiming "Implied License." If you build a backend based on this spec, you are knowingly infringing.
              </p>
            </div>
