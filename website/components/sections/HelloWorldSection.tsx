...
const nodeCode = `import { init } from "@iii-dev/sdk";
...
export function HelloWorldSection({ isDarkMode = true }: HelloWorldSectionProps) {
      ...
      <div className="relative z-10">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-4">
          ...
          <p className={`text-sm md:text-base lg:text-lg max-w-3xl mx-auto leading-relaxed ${textSecondary}`}>
            Python registers a function. Rust registers a function. Node.js consumes both.
          ...
          {codeBlocks.map((block, index) => (
            <div key={index} className="relative h-full">
              ...
              `}>
                ...
                `}>
                  <div className={`p-2 rounded-lg ${isDarkMode ? 'bg-white/5' : 'bg-black/5'} ${block.color}`}>
                    <block.icon />
                  </div>
                  <div>
                ...
                {/* Code */}
                <div className={`flex-1 p-0 overflow-hidden text-left ${isDarkMode ? 'bg-iii-black' : 'bg-iii-light'}`}>
                  <Highlight
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          `}>
            ...
            <span className={`text-xs md:text-sm ${textSecondary}`}>
              <span className={accentColor}>Inter-process communication</span> across languages, domains, and systems
            </span>
          </div>
        </div>
      </div>
