  ...
  const handleCommand = (cmd: string) => {
    ...
    switch (baseCommand) {
      ...
      case 'modules':
        ...
        addLog('', 'info');
        addLog('► Streams', 'success');
        addLog('  Real-time durable subscriptions', 'info');
        addLog('', 'info');
        addLog('► Cron', 'success');
      ...
      case 'adapters':
        ...
        addLog('', 'info');
        addLog('Adapters are configured in config.yaml', 'warning');
        break;
      ...
      case 'triggers':
        ...
        addLog('├──────────────┼────────────────────────────────────────────┤', 'info');
        addLog('│ api          │ REST API endpoints (api_path, http_method) │', 'success');
        addLog('│ cron         │ Scheduled execution (cron expression)      │', 'success');
