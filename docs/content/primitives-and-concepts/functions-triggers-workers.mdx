---
title: 'Functions, Triggers, Workers'
fullTitle: 'Primitives: Functions, Triggers, and Workers'
...
A **Worker** is any process that can define Functions and Triggers to accomplish one or more tasks. They are typically
...
the same access to invokation, state, and other engine functionality as other Functions do.
</Callout>
...
Head over to the [Functions & Triggers](/docs/how-to/use-functions-and-triggers) HOWTO and start building
a iii powered application; or visit the [Quickstart](/docs/tutorials/quickstart) and try out a working example.

## Still want to learn more?

Check out how [Discovery](/docs/concepts/discovery) works within iii and how it compares to other solutions.
