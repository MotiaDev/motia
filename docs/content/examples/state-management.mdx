...
iii.register_function({"id": "users.update_status"}, update_user_status)
...
iii.register_function({"id": "users.get_status"}, get_user_status)
iii.register_trigger({
...
iii.register_function({"id": "cron.orders_audit"}, orders_audit)
...
| Read one | `await iii.trigger({ function_id: 'state::get', payload: { scope, key } })` | `iii.trigger({'function_id': 'state::get', 'payload': {...}})` | `iii.trigger(TriggerRequest::new("state::get", json!({...}))).await?` |
| Read all in scope | `await iii.trigger({ function_id: 'state::list', payload: { scope } })` | `iii.trigger({'function_id': 'state::list', 'payload': {...}})` | `iii.trigger(TriggerRequest::new("state::list", json!({...}))).await?` |
