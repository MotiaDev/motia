...
iii.register_function(RegisterFunctionMessage { id: "data.processor".into(), ..Default::default() }, move |input: Value| {
...
iii.register_function(RegisterFunctionMessage { id: "data.sender".into(), ..Default::default() }, move |input: Value| {
...
iii.register_function(RegisterFunctionMessage { id: "stream.worker".into(), ..Default::default() }, move |input: Value| {
...
iii.register_function(RegisterFunctionMessage { id: "stream.coordinator".into(), ..Default::default() }, move |input: Value| {
