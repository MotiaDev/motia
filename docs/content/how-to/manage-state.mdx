...
# Then call from another function or worker
result = iii.trigger({'function_id': 'users::create', 'payload': {'name': 'Alice', 'email': 'alice@example.com'}})
...
def get_user(input):
    ...
    user = iii.trigger({'function_id': 'state::get', 'payload': {
        'scope': 'users',
        'key': input['userId'],
    }})
...
# Then call from another function or worker
user = iii.trigger({'function_id': 'users::get', 'payload': {'userId': 'some-user-id'}})
...
# Then call from another function or worker
iii.trigger({'function_id': 'users::record-login', 'payload': {'userId': 'some-user-id'}})
