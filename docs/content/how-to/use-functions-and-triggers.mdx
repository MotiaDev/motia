...
| Function | Purpose | Parameters |
|----------|---------|------------|
| `engine::functions::list` | List all registered functions | `include_internal` (optional) |
| `engine::workers::list` | List all workers with metrics | `worker_id` (optional) |
| `engine::triggers::list` | List all triggers | `include_internal` (optional) |
| `engine::workers::register` | Register worker metadata | `worker_id` |
...
| Function | Purpose | Parameters |
|----------|---------|------------|
| `engine::log::info` | Log info message | `message`, `service_name`, `attributes` |
| `engine::log::warn` | Log warning message | `message`, `service_name`, `attributes` |
| `engine::log::error` | Log error message | `message`, `service_name`, `attributes` |
| `engine::log::debug` | Log debug message | `message`, `service_name`, `attributes` |
| `engine::log::trace` | Log trace message | `message`, `service_name`, `attributes` |
...
| `engine::traces::list` | List stored traces | `trace_id`, `service_name`, `name`, `status`, `offset`, `limit`, ... |
| `engine::traces::tree` | Get trace tree | `trace_id` |
| `engine::traces::clear` | Clear stored traces | — |
| `engine::metrics::list` | List current metrics | `metric_name`, `metric_type` (optional) |
| `engine::logs::list` | List stored logs | `trace_id`, `span_id`, `severity_min`, `offset`, `limit`, ... |
...
| `engine::rollups::list` | Get pre-aggregated metrics | `start_time`, `end_time`, `aggregate_interval`, `metric_name` |
