...
<Image src="/docs/console/functions.png" alt="Functions screen showing registered functions grouped by service namespace" />
...
<Image src="/docs/console/functions-invoke.png" alt="Function invoke panel showing JSON input editor and response output" />
...
<Image src="/docs/console/triggers.png" alt="Triggers screen showing HTTP, cron, and queue triggers grouped by type" />
...
<Image src="/docs/console/triggers-detail.png" alt="Trigger detail panel showing HTTP request builder with method, path, and body fields" />
...
<Callout title="Trigger types" type="info">
  The available trigger types depend on which modules are loaded in your engine configuration. See [Trigger Types](/docs/architecture/trigger-types) and [Modules](/docs/modules) for the full list.
</Callout>
...
<Image src="/docs/console/states.png" alt="States screen showing the three-panel layout with groups, items table, and JSON detail sidebar" />
...
<Image src="/docs/console/states-detail.png" alt="State detail panel showing full JSON value with edit controls" />
...
<Image src="/docs/console/logs.png" alt="Logs screen showing structured log entries with severity, service, trace context, and message columns" />
...
<Image src="/docs/console/logs-list.png" alt="Logs list showing structured log entries with severity, service, and message" />
...
<Image src="/docs/console/logs-detail.png" alt="Expanded log entry showing full JSON payload with attributes and trace context" />
