...
iii.register_function(RegisterFunctionMessage { id: "orders::process".into(), ..Default::default() }, |input| async move {
...
<Callout type="info" title="Engine-level invocation metrics">
...
<Tabs groupId="language" persist items={['Node / TypeScript', 'Python']}>
  <Tab value="Node / TypeScript">
...
<Callout type="warn" title="Python SDK does not use OTEL_EXPORTER_OTLP_ENDPOINT">
