...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    iii.register_function(RegisterFunctionMessage { id: "users::create".into(), ..Default::default() }, |input| async move {
        let logger = Logger();
...
iii.register_function(RegisterFunctionMessage { id: "handler".into(), ..Default::default() }, |input| async move {
