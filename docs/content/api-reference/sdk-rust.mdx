...
```rust
register_function(id: impl Into<String>, handler: H) -> FunctionRef
```
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `id` | `impl Into<String>` | Yes | Unique function identifier. |
...
```rust
register_function_with_description(id: impl Into<String>, description: impl Into<String>, handler: H) -> FunctionRef
```
...
| `description` | `impl Into<String>` | Yes | - |
| `handler` | `H` | Yes | - |
...
```rust
register_service(id: impl Into<String>, description: Option<String>)
```
...
```rust
register_service_with_name(id: impl Into<String>, name: impl Into<String>, description: Option<String>)
```
...
| --- | --- | --- | --- |
| `id` | `impl Into<String>` | Yes | - |
| `name` | `impl Into<String>` | Yes | - |
| `description` | `Option<String>` | No | - |

### register_service_with_parent
...
```rust
register_service_with_parent(id: impl Into<String>, name: Option<String>, description: Option<String>, parent_service_id: Option<String>)
```
...
```rust
register_trigger(trigger_type: impl Into<String>, function_id: impl Into<String>, config: impl serde::Serialize) -> Result<Trigger, IIIError>
```
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `trigger_type` | `impl Into<String>` | Yes | Trigger type (e.g. `"http"`, `"cron"`). |
| `function_id` | `impl Into<String>` | Yes | ID of the function to invoke. |
| `config` | `impl serde::Serialize` | Yes | Trigger-specific configuration (serializable). |
...
```rust
on_connection_state_change(callback: F) -> ConnectionStateGuard
```
