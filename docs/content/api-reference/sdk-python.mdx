...
```python
on_connection_state_change(callback: ConnectionStateCallback)
```
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| `callback` | `ConnectionStateCallback` | Yes | - |
...
```python
register_service(id: str, description: str | None = None, parent_id: str | None = None)
```
