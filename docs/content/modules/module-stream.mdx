...
<Tab value="Rust">
```rust
iii.register_function(RegisterFunctionMessage { id: "onAuth".into(), ..Default::default() }, |_input| async move {
...
<Tab value="Rust">
```rust
iii.register_function(RegisterFunctionMessage { id: "onJoin".into(), ..Default::default() }, |input| async move {
    println!("Joined stream: {:?}", input);
    Ok(json!({}))
});

iii.register_trigger(RegisterTriggerInput { type_: "stream:join".into(), function_id: "onJoin".into(), config: json!({}), ..Default::default() })?;
```
</Tab>
</Tabs>
...
<Tab value="Rust">
```rust
iii.register_function(RegisterFunctionMessage { id: "stream::auth".into(), ..Default::default() }, |input| async move {
...
<Tab value="Rust">
```rust
iii.register_function(RegisterFunctionMessage { id: "conditions::requireContext".into(), ..Default::default() }, |input| async move {
    let has_user = input
        .get("context")
...
iii.register_trigger(RegisterTriggerInput { type_: "stream:join".into(), function_id: "onJoin".into(), config: json!({
